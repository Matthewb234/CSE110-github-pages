...
Some Frameworks I'm familiar with are:
1. Flutter
2. Django

## Projects:
Below is a list of porjects that I've either completed, am workign on, or want to do in the future.
- [X] [Tetris](https://github.com/Matthewb234/Tetris) (For Girlfriend)
- [X] Smart Room (Custom IoT)
